...
class WireMockProvider {
    ...
    private static void configureQueryStubs() {
        ...
        final String EXPECTED_DURATION_REQUEST = "{\"query\":\"query{getDuration(durationToReturn: \\\"PT7H\\\")}\"}";
        final String EXPECTED_DURATION_REQUEST_RESULT = "{\"data\": {\"getDuration\": \"PT7H\"}}";

        final String EXPECTED_UUID_REQUEST = "{\"query\":\"query{getUuid(uuidToReturn: \\\"789c07ba-54bc-47e6-84ba-165e1a68cb37\\\")}\"}";
        final String EXPECTED_UUID_REQUEST_RESULT = "{\"data\": {\"getUuid\": \"789c07ba-54bc-47e6-84ba-165e1a68cb37\"}}";
        ...
        addGraphQlStub(EXPECTED_OPTIONAL_REQUEST, OPTIONAL_RESULT, DEFAULT_HEADERS);
        ...
        addGraphQlStub(EXPECTED_DURATION_REQUEST, EXPECTED_DURATION_REQUEST_RESULT, DEFAULT_HEADERS);
