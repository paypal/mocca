...
class WireMockProvider {
    ...
    private static void configureQueryStubs() {
        ...
        final String EXPECTED_OPTIONAL_REQUEST =       "{ \"query\" : \"query{getSuperComplexStuff(superComplexSampleType: {booleanVar: true, duration: \\\"PT3H\\\", intVar: 1, optionalField: \\\"love\\\", sampleEnum: \\\"Sample2\\\", stringVar: \\\"one\\\", uuid: \\\"229c07ba-04bc-49a6-13bc-165e1a54cb32\\\"}) {booleanVar complexField {innerBooleanVar innerIntVar innerStringListVar innerStringVar} complexListVar {innerBooleanVar innerIntVar innerStringListVar innerStringVar} dateTime duration intVar optionalField sampleEnum stringListVar stringSetVar stringVar uuid}}\" }";
        final String OPTIONAL_RESULT = "{\"data\": {\"getSuperComplexStuff\": {\"booleanVar\": true, \"intVar\": 1, \"optionalField\": \"love\", \"sampleEnum\": \"Sample2\", \"stringVar\": \"one\", \"duration\": \"PT3H\", \"uuid\": \"229c07ba-04bc-49a6-13bc-165e1a54cb32\" }}}";
