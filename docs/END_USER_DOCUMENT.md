...
If application wants to use the `Book` DTO as return type, but it wants to ignore the title field only. Notice `SelectionSet` ignore must be sent as an array of String values.
