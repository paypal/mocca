...
public final class MoccaResilience4j extends MoccaResiliency {
    ...
    private MoccaResilience4j(final MoccaResilience4jFeignDecorators decorators) {
    ...
    public static class Builder {
        ...
        public MoccaResilience4j build() {
            return new MoccaResilience4j(new MoccaResilience4jFeignDecorators(feignBuilder.build()));
        }
